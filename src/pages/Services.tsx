  ...
  const serviciosAdicionales = [
    {
      ...
      content: "¿Quieres iniciar o expandir tu colección de arte? Te ayudamos a encontrar obras que no solo embellecen, sino que cuentan historias. Cada pieza es elegida con criterio curatorial y conexión emocional."
    },
    {
